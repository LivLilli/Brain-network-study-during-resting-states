...
'''
sub_PDC() class to compute PDC on just a subset of channels.

It makes a graphical representation of the network, using given Cartesian coordinates
...
class sub_PDC(object):
    ...
    def final_pdc_matrix(self):
        freq_selection,idx = self.MVar_PDC()
