...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 12 13:00:40 2019
...
class sub_DTF(object):
    ...
    def MVar_DTF(self):
        ...
        # resolution = fs/2
        pdc = cp.conn.dtf_fun(A_matrix, V_matrix, self.fs, self.fs//2)
    ...
    def final_dtf_matrix(self):
        freq_selection,idx = self.MVar_DTF()
    ...
    def adj_matrix(self):
        matrix_no_diagonal,idx = self.final_dtf_matrix()
    ...
    def graph(self):
        ...
        nx.draw_networkx_edges(G, pos=coord_dic_19, arrowstyle='->',
...
if __name__=="__main__":
    ...
    # initialize sub_PDC class for file1
    dtf1 = sub_DTF(file1, channels_19, txt_file, density1)
    # initialize sub_PDC class for file2
    dtf2 = sub_DTF(file2,channels_19, txt_file, density1)
